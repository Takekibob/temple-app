...
export default function MembershipsSetupPage() {
            ...
            >
              ...
              {isSelected && template.membershipTypes.length > 0 && (
                <div className="mt-3 pt-3 border-t border-stone-100 space-y-1.5">
                  <p className="text-xs font-semibold text-stone-600 mb-2">作成されるメンバーシップ種別：</p>
              ...
              {isSelected && template.key === "custom" && (
                <div className="mt-3 pt-3 border-t border-stone-100">
                  <p className="text-xs text-stone-400">
                    テンプレートは生成されません。次の画面でゼロから自由に設計してください。
                  </p>
                </div>
              )}
            </button>
